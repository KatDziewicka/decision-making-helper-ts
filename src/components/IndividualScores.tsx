    ...
    <div>
      <div>
        ...
        <input type="range" id="taste" name="taste"
         min="0" max="10" onChange={(e)=>dispatch({type: CriterionKinds.TASTE, newScore: e.target.value})}></input>
      </div>
      <div>
        Value for money weight: {state.valueForMoneyScore}
        <input type="range" id="value" name="value"
         min="0" max="10" onChange={(e)=>dispatch({type: CriterionKinds.VALUE_FOR_MONEY, newScore: e.target.value})}></input>
      </div>
      <div>
        Healthiness weight: {state.healthinessScore}
        <input type="range" id="healthiness" name="healthiness"
         min="0" max="10" onChange={(e)=>dispatch({type: CriterionKinds.HEALTHINESS, newScore: e.target.value})}></input>
      </div>
    </div>
    );
  };
